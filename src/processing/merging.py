...
def cleaning_and_merging(tmdb_crit_cols: List[str] = TMDB_CRIT_COLS,
    ...
    logger.info(f'Movie-genre pivot table creation complete: {movie_genre_pivot.shape[0]} links')
    # if export == True:
