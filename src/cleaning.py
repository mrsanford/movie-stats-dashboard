...
from src.helpers import (GENRE_COLS_TO_DROP, TMDB_COLS_TO_DROP,
    ...
    GENRES_OUTPUT_PATH, TMDB_OUTPUT_PATH, BUDGET_OUTPUT_PATH, RATING_MAP, PRUNED_TMDB_COLS,
    PRUNED_GENRE_COLS, PRUNED_BUDGET_COLS)
...
def clean_tmdb_to_csv(
    ...
    target_column_order: list = PRUNED_TMDB_COLS,
    export: bool = True,
) -> pd.DataFrame:
    """
...
def clean_budgets_to_csv(
    ...
    target_column_order: list = PRUNED_BUDGET_COLS,
    export: bool = True,
) -> pd.DataFrame:
    """
